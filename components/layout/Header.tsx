    ...
    <header className="sticky top-0 z-30 h-16 w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800/80 px-4 md:px-6 flex items-center justify-between transition-colors">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button
          ...
          className="h-9 px-3.5 rounded-xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-xs font-bold shadow-sm flex items-center gap-1.5 transition-all active:scale-95 hover:bg-slate-800 dark:hover:bg-slate-100"
        >
        ...
        >
          {theme === 'light' ? <Moon className="w-4 h-4 text-slate-700" /> : <Sun className="w-4 h-4 text-slate-300" />}
        </button>
        ...
        <div className="relative">
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute top-1.5 right-1.5 w-2.5 h-2.5 bg-slate-900 dark:bg-white rounded-full border-2 border-white dark:border-slate-900" />
            )}
          </button>
                    ...
                    <div
                      ...
                      className={`p-2.5 rounded-xl text-xs cursor-pointer transition-colors ${
                        n.isRead
                          ...
                          : 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-100 font-medium border-l-2 border-slate-900 dark:border-white'
                      }`}
                    >
