    ...
    <header className="sticky top-0 z-30 h-16 w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800/80 px-4 md:px-6 flex items-center justify-between transition-colors">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button
          ...
          className="h-9 px-3.5 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white text-xs font-semibold shadow-md shadow-violet-500/20 flex items-center gap-1.5 transition-all active:scale-95"
        >
            ...
            {isNotifOpen && (
              ...
              >
                <div className="flex items-center justify-between pb-2 mb-2 border-b border-slate-100 dark:border-slate-800">
                  ...
                  <span className="text-[10px] text-violet-600 dark:text-violet-400 font-medium">Auto-synced</span>
                </div>
                    ...
                    <div
                      ...
                      className={`p-2.5 rounded-xl text-xs cursor-pointer transition-colors ${
                        n.isRead
                          ...
                          : 'bg-violet-50 dark:bg-violet-950/40 text-slate-800 dark:text-slate-200 font-medium border-l-2 border-violet-600'
                      }`}
                    >
