    ...
    <div className="space-y-6 pb-16 max-w-5xl mx-auto">
      ...
      <div className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-3">
        <div>
          ...
          <p className="text-[11px] text-slate-400">Specify total sales revenue generated today in INR (₹)</p>
        </div>

        <div className="p-3.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 max-w-sm">
          <label className="text-xs font-bold text-emerald-700 dark:text-emerald-400 block truncate mb-1">
            Total Revenue Closed (₹)
          </label>
            <input
              type="number"
